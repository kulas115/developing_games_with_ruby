...
#   let(:box) { AxisAlignedBoundingBox.new([5, 5], [10, 10]) }
...
#       let(:box) { AxisAlignedBoundingBox.new([0, 0], [10, 10]) }
#       let(:location) { [0, 0] }
...
#           50.times do |_i|
#             tree.insert(
#               GameObject.new(rand(0..10), rand(0..10))
#             )
#           end
#         end
...
#       context 'is found' do
#         let(:query_params) { [object.location, object.location.map { |c| c + 1 }] }
#       end
#     end
#   end
...
#       before do
#         50.times do
#           tree.insert(GameObject.new(rand(0..10), rand(0..10)))
#         end
#       end
...
#       it 'removes it' do
#         expect(subject.size).to eq(50)
#         subject.each { |object| expect(tree.remove(object)).to be_truthy }
#         expect(tree.query_range(box).size).to eq(0)
#       end
#     end
#   end
# end
